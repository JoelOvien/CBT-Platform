...
import 'package:cbt_platform/utilities/widgets/custom_progress_indicator.dart';
      ...
      body: Padding(
        ...
        child: Consumer(builder: (context, ref, __) {
          ...
          return RefreshIndicator(
            onRefresh: () async {
              candidateExamController.fetchAllRegisteredCoursesForStudent(context);
            },
            child: SingleChildScrollView(
              physics: const AlwaysScrollableScrollPhysics(),
              child: Column(
                children: [
                  if (candidateExamController.registeredCourses.isEmpty)
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          Center(
                            child: Text(
                              "No courses registered yet, contact the ICT Admin",
                  ...
                  else if (candidateExamController.loadingRegisteredCourses)
                    SizedBox(
                      height: screenHeight(context, percent: 0.7),
                      child: const Center(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Please select your examination and start immediately!",
                          ...
                          children: [
                            Expanded(
                              child: Wrap(
                                ...
                                children: [
                                  ...List.generate(
                                    candidateExamController.registeredCourses.length,
                                    (index) => MaterialButton(
                                      onPressed: () {
                                        candidateExamController.selectedCourse = candidateExamController.registeredCourses[index];
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                Text(
                                                  candidateExamController.registeredCourses[index].courseCode!,
                                                  style: mediumStyle(
                                                    18,
                                                    AppColors.black1E,
                                                  ),

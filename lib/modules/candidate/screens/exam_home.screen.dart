                  ...
                  Column(
                    children: [
                      Container(
                        ...
                        child: Column(
                          children: [
                            titleValueTextWidget("Course Code: ",
                                candidateExamController.selectedCourse.courseCode!),
                            const YMargin(20),
                            titleValueTextWidget("Course Title: ",
                                candidateExamController.selectedCourse.courseTitle!),
                            const YMargin(20),
